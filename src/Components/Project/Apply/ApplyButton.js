...
const ApplyButton = (props) => {
  ...
  /**
   * Handles the project apply button.
   * Adds user to the project.
   */
  const applyProject = async () => {
    window.confirm(
      "Are you sure you want to join the project? Your information will be shared with the owner."
    );
  ...
  /**
   * Changes the motivations text state when the textfield is changes.
   * @param {*} event 
   */
      ...
      <div>
        ...
        <Modal open={open} onClose={handleClose}>
          ...
          >
            ...
            />
            <Button color="darkViolet" onClick={applyProject}>
              Send application
            </Button>
          </Box>
        </Modal>
