  ...
  return (
    <>
      <div style={{ alignItems: "center", flexDirection: "column", display: "flex", }}>
        <Typography variant="h4" sx={{color:"#a8ba30"}}>UPDATE PROJECT INFORMATION</Typography>
        <TextField
          sx={{ input:{color:"whitesmoke", background:"#545ac4"}, marginTop:"20px" }}
          required
          label="Title"
          value={title}
        ...
        <p></p>
        <Typography variant="h6" sx={{color:"#a8ba30"}}>Tags and skills are added using the enter button</Typography>
        <p></p>
        <TagsInput />
        <p></p>
        <SkillsInput />
